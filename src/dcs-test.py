...
ckpt = torch.load(f"./ckpt/dcs_r32t256k8/e30b100gd10.pth.tar", map_location=device)
...
for snr_idx, snr in enumerate(SNR_vec):
    ...
    TestDataloader = torch.utils.data.DataLoader(
        utils.Measurement(H_all[:opt.n_test], h_all[:opt.n_test], Phi, snr, transform=transform),
